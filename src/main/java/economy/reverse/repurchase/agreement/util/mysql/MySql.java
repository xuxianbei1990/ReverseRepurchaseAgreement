...
public class MySql {
    ...
    public void execute(List<Fund110003> fund110003s) {
...
//            connection.rollback();
    ...
    public List<Fund110003> executeSelect() {
        Properties properties = null;
    ...
    private static void executeQuery(Connection connection, StatementResultSet statementResultSet) throws SQLException {
        PreparedStatement preparedStatement = connection.prepareStatement("SELECT unit, sum, create_date FROM fund110003 WHERE create_date >= '2012-09-27'");
        ResultSet resultSet = preparedStatement.executeQuery();
        statementResultSet.setResultSet(resultSet);
        statementResultSet.setPreparedStatement(preparedStatement);
    }

    private static void executeUpdate(Connection connection, StatementResultSet statementResultSet, Fund110003 fund110003) throws SQLException {
        PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO fund110003 (unit, sum, create_date) values ( ?, ?, ?) ");
